	...
	$(document).ready(function()
	{
		$("#q").keyup(function(){
				...
				$.post('admin_ser.php',{q:txt},function(data){
					$("#feedback").html(data);
					$("#feedback").append('<div class="input-group"><span class="input-group-btn"><button type="button" onclick="sendSMS()" class="btn btn-primary">Send SMS</button></span></div>');
				});
			
		});
		function sendSMS() {
            // Your send SMS function code here
        }
	});
  </script>
